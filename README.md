...
location:   "Tokyo, JP"
role:       "Vibe Coder / AI Systems Architect"
philosophy: "Ship fast. Stay sharp. Let AI handle the syntax."
```

> I don't write code. I conduct it.
...
|:--|:--------|:------------|:------|
| **01** | **Personal AI OS** | Memory-augmented multi-agent system for 100x output | Next.js · Supabase · pgvector · Gemini |
...
```
  ...
  2028       ──── Independent builder / entrepreneur
